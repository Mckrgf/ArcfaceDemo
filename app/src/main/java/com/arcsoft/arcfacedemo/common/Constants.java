...
public class Constants {
    ...
    public static final String APP_ID = "72kkCvftMbEhBeeVH5zxuiaJKTMHf5sNPLS19g9xEMgv";
    public static final String SDK_KEY = "GE69LzPwk86o4PU9bHYMb3QXQydjmCxyGX2mvvYBXmbN";
